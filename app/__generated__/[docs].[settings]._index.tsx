...
<Fragment_1>
<div
className={`w-element c7z4ryg c1bv1fm7 c10ahqwr ccy4onp c12v245d czcq795 cvam674 cjnw8bq c8rm0tm cvyvt8m cegjyhq cnq5uvv cn7vhbn`}>
<div
...
className={`w-html-embed c10svky5`} />
</Box>
</Button>
</NavigationMenuTrigger>
<NavigationMenuContent
className={`w-menu-content c1rbzz7m c1bq9k1t c4im5ri c1kael5w c1ays5ld`}>
<Box
...
<Link_1
href={"/docs"}
className={`w-link cmx2o2d c10ahqwr c1atdl27 cvvc3zs cq4ywzg cb3my67 c170tjmx c1vn5tfs czucxib c1kp31s8 crxt7mc cdjvmmy c1anpkwc c16ya8nv c5gq79w cfq9b07 cbsu0mq cpv83kh cufe47 czck9s6 c19z7nzm cncksmc czmuqwl c1hpqdu5`}>
<Text
className={`w-text c1qhcdyy c1xbn7ez crxt7mc c10svky5`}>
{"Documents"}
</Text>
<Paragraph
className={`w-paragraph c1cvc1fy cdmq0wa c1unn2rf c1qhcdyy cicl67j c1hvvxg4 cwjh6ed`}>
...
<Link_1
href={"/support"}
className={`w-link cmx2o2d c10ahqwr c1atdl27 cvvc3zs cq4ywzg cb3my67 c170tjmx c1vn5tfs czucxib c1kp31s8 crxt7mc cdjvmmy c16ya8nv c5gq79w cfq9b07 cbsu0mq cpv83kh cufe47 czck9s6 c19z7nzm cncksmc czmuqwl c1hpqdu5`}>
<Text
className={`w-text c1qhcdyy c1xbn7ez crxt7mc c10svky5`}>
...
<Link_1
href={"/privacy-policy"}
className={`w-link cmx2o2d c10ahqwr c1atdl27 cvvc3zs cq4ywzg cb3my67 crxt7mc cdjvmmy c16ya8nv c5gq79w cfq9b07 cbsu0mq cpv83kh c170tjmx c1vn5tfs c1kp31s8 czucxib cufe47 czck9s6 c19z7nzm cncksmc czmuqwl c1hpqdu5`}>
<Text
className={`w-text c1qhcdyy c1xbn7ez crxt7mc c10svky5`}>
{"Privacy Policy"}
</Text>
...
<Paragraph
className={`w-paragraph c1cvc1fy cdmq0wa c1unn2rf c1huger0 coxefsf c1qhcdyy cicl67j c1hvvxg4 cwjh6ed`}>
...
className={`w-menu-viewport c18r7lsh csaddr c1cvc1fy cdmq0wa c1tc6v8u cen3wsf c18rgb3y caqkv26 cirmrkx chdvygq c145ebzo c169pe5h c109howh cafscv2 c1tt00pm c5gq79w cfq9b07 cbsu0mq cpv83kh`} />
</Box>
</NavigationMenu>
<NavigationMenu
className={`w-navigation-menu c18r7lsh c1nkdqmy c2cg3w5 c1bq8pra`}>
<NavigationMenuList
...
className={`w-button c6t8baf ccy4onp c12v245d c1phwbjc c1qhcdyy c1fi5cuq cht0eit ci7vqja c7feqdc c170tjmx c1vn5tfs c1kp31s8 czucxib cf7vwbz c1pt54az c1v1aqip c1fybrir c16ya8nv c5gq79w cfq9b07 cbsu0mq cpv83kh c1ksihlx cge9bev cjk2p3u c1ey153p c1wffj6h cg3odet cwblwtu c14z3omo ca508ev c1r1ndh8 cfl6z32 ckffmm9 crs1rsf c1q1affg cjb1u0k c1uzl7ts cao2a7h c1jvzd51 cgq20k9`}>
<Box
className={`w-box c1uc2j84 c1kss2rn c1mrqewb`}>
<HtmlEmbed
...
<Box
className={`w-box c12fyb4s chu2gw7 c10ahqwr c12v245d c1x5aw03 c15f3w52`}>
<NavigationMenuViewport
className={`w-menu-viewport c18r7lsh csaddr c1cvc1fy cdmq0wa c1tc6v8u cen3wsf c18rgb3y caqkv26 cirmrkx chdvygq c145ebzo c169pe5h c109howh cafscv2 c1tt00pm c5gq79w cfq9b07 cbsu0mq cpv83kh`} />
</Box>
</NavigationMenu>
...
<MarkdownEmbed
code={"[Documents Home](/docs) / [Other](/docs#other) / **Settings**"}
...
<MarkdownEmbed
code={"## General\n### Basic\n\n- **Launch at Login**\n  - Make Clip Hold open automatically when you login to Mac.\n  - Default: `Off`\n\n### Menu\n\n- **Maximum Number of Standard Phrases to Display**\n  - Set the maximum number of standard phrases to display in the menu.\n  - Default: `5`\n- **Maximum Number of History Items to Display**\n  - Set the maximum number of history items to display in the menu.\n  - Default: `10`\n- **Date and Time Display Format**\n  - Changes how the date is displayed when copied. You can choose from the following options.\n    - **Absolute** (Default)\\\n      Example: 11/30/2025, 12:34PM\n    - **Relative**\\\n      Example: 5 minutes ago\n    - **Both: Absolute (Relative)**\\\n      Example: 11/30/2025, 12:34PM (5 minutes ago)\n    - **Both: Absolute - Relative**\\\n      Example: 11/30/2025, 12:34PM - 5 minutes ago\n    - **Both: Relative (Absolute)**\\\n      Example: 5 minutes ago (11/30/2025, 12:34PM)\n    - **Both: Relative - Absolute**\\\n      Example: 5 minutes ago - 11/30/2025, 12:34PM\n- **Show Current Preset Icon**\n  - Shows the currently selected preset icon in the menu bar instead of the Clip Hold icon.\n  - Default: `Off`\n- **Hide the Menu Bar Icon**\n  - Temporarily hide the Clip Hold menu bar icon. It will reappear when you open the app again.\n  - Default: `Off`\n\n### Quick Paste\n\n- **Quick Paste**\n  - When selecting a standard phrase or copy history item from the menu, or when copying using shortcut keys, the Command + V key action is sent. Accessibility permission is required.\n  - Default: `Off`\n- **Text Only**\n  - Make Quick Paste perform only when the history item is text.\n  - Default: `Off`\n- **Quick Paste to Previous Text Field**\n  - When copying from the History and Standard Phrases windows, return focus to the app that had the previously selected text field and perform a quick paste. When this option is enabled, quick paste is also available for the new copy and change item and copy features. Accessibility permission is required.\n  - Default: `Off`\n\n> **Tip**\\\n> For more details on Quick Paste, please see [**this documentation**](/docs/standard-phrases-and-copy-history#quick-paste).\n\n### Quick Overlay\n\n- **Show with Shortcut Key**\n  - When enabled, the overlay is displayed only while holding down the configured shortcut key, allowing you to copy easily by moving the pointer over the desired item and releasing the key.\n  - Default: `Off`\n- **Delay Before Display**\n  - Specify the time to hold down the shortcut key before Quick Overlay is displayed.\n  - Default: `0.0s`\n- **Display Position**\n  - Select the position on the screen where Quick Overlay is displayed.\n  - Default: `Near Pointer`\n- **Date and Time Display Format**\n  - Changes the date and time display format for Quick Overlay.\n  - Default: `Both: Relative (Absolute)`\n- **Screen Edge...**\n  - Opens settings to display Quick Overlay by touching screen edges with the mouse cursor.\n- **How to use Quick Overlay...**\n  - Opens the Quick Overlay tutorial."}
...
<h1
className={`w-element cvddzxn cbgovzd c117tk5u clk5tgp c7ep1pc c1ucel5e c1f3f3n8 cks20wo`}>
{"Clip Hold"}
</h1>
<p
className={`w-element c1ucel5e c7qjy52 clk5tgp c1dgg9g4 c1f3f3n8 cqx7kte`}>
...
<p
className={`w-element cmfetcc cqo7lub cqrwb2y cbgovzd c1f3f3n8`}>
