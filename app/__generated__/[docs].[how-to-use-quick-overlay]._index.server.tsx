...
export const getResources = (_props: { system: System; resources?: Record<string, any> }) => {
  ...
  return {
    title: "How to Use Quick Overlay - Clip Hold",
    description: "You can easily copy your history and standard phrases from the Quick Overlay, which can be accessed from the edge of the screen, or using keyboard shortcuts.",
