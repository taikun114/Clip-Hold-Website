...
<MarkdownEmbed
code={"## 一般\n### Clip Holdの設定\n\n- **ログイン時に開く**\n  - Macのログイン時にClip Holdを起動するかどうかを切り替えます。\n  - デフォルト: オフ\n- **クイックペースト**\n  - クイックペースト機能を使用するかどうかを切り替えます。クイックペースト機能については[**こちらのページ**](https://github.com/taikun114/Clip-Hold/wiki/Standard-Phrases-and-Copy-History#%E3%82%AF%E3%82%A4%E3%83%83%E3%82%AF%E3%83%9A%E3%83%BC%E3%82%B9%E3%83%88)をご覧ください。\n  - デフォルト: オフ\n- **テキストのみ**\n  - クイックペーストを行う際、テキストのみを対象とするかどうかを切り替えます。\n\n### メニュー\n\n- **メニューに表示する定型文の最大数:**\n  - メニューに表示する定型文の最大数を設定します。\n  - デフォルト: 5\n- **メニューに表示する履歴の最大数:**\n  - メニューに表示する履歴の最大数を設定します。\n  - デフォルト: 10\n- **メニューバーアイコンを一時的に非表示**\n  - メニューバーアイコンを非表示にするかどうかを切り替えます。アプリを開き直すと再びアイコンが表示されるようになります。\n  - デフォルト: オフ"}
