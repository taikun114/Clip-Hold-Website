...
import {
  ...
  breakpoints,
} from "../__generated__/[jp].[docs].[standard-phrases-window-and-history-window]._index";
import {
  getResources,
  getPageMeta,
  getRemixParams,
  contactEmail,
} from "../__generated__/[jp].[docs].[standard-phrases-window-and-history-window]._index.server";
